...
/***/ function(module, exports, __webpack_require__) {
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(CounterNumber, { count: this.state.counter }),
					_react2.default.createElement(IncrementButton, { onClick: this.increment }),
					_react2.default.createElement(DecrementButton, { onClick: this.decrement })
				);
			}
		}]);
	...
	var CounterNumber = function (_React$Component2) {
		_inherits(CounterNumber, _React$Component2);
	...
	var IncrementButton = function (_React$Component3) {
		_inherits(IncrementButton, _React$Component3);
		...
		_createClass(IncrementButton, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'button',
					{ className: 'btn btn-primary', style: btnStyle, onClick: this.props.onClick },
					'+'
				);
			}
		}]);
	...
	var DecrementButton = function (_React$Component4) {
		_inherits(DecrementButton, _React$Component4);
		...
		_createClass(DecrementButton, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'button',
					{ className: 'btn btn-danger', style: btnStyle, onClick: this.props.onClick },
					'-'
				);
			}
		}]);
