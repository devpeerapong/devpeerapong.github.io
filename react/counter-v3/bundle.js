...
/***/ function(module, exports, __webpack_require__) {
	...
	var _counterv = __webpack_require__(1);

	var _counterv2 = _interopRequireDefault(_counterv);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
		...
		function App(props) {
			...
			_this.addCounter = _this.addCounter.bind(_this);
			_this.removeCounter = _this.removeCounter.bind(_this);
			_this.removeCounterByIndex = _this.removeCounterByIndex.bind(_this);
		...
		_createClass(App, [{
			...
			key: 'removeCounterByIndex',
			value: function removeCounterByIndex(index) {
				var newState = this.state;
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(AddCounterButton, { onClick: this.addCounter }),
					_react2.default.createElement(RemoveCounterButton, { onClick: this.removeCounter }),
					this.state.counter.map(function (count) {
						return _react2.default.createElement(Counter, {
							key: count.id,
							index: count.id,
							count: count.count,
							increment: _this2.increment,
							decrement: _this2.decrement,
							remove: _this2.removeCounterByIndex });
					})
				);
			}
		}]);
	...
	var AddCounterButton = function (_React$Component2) {
		_inherits(AddCounterButton, _React$Component2);

		function AddCounterButton(props) {
			_classCallCheck(this, AddCounterButton);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(AddCounterButton).call(this, props));
		}

		_createClass(AddCounterButton, [{
			key: 'render',
			value: function render() {
				var btnStyle = {
					width: '300px',
				...
				return _react2.default.createElement(
					'button',
					{ className: 'btn btn-info', style: btnStyle, onClick: this.props.onClick },
					'+ Counter'
				);
			}
		}]);
	...
	var RemoveCounterButton = function (_React$Component3) {
		_inherits(RemoveCounterButton, _React$Component3);

		function RemoveCounterButton(props) {
			_classCallCheck(this, RemoveCounterButton);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(RemoveCounterButton).call(this, props));
		}

		_createClass(RemoveCounterButton, [{
			key: 'render',
			value: function render() {
				var btnStyle = {
					width: '300px',
				...
				return _react2.default.createElement(
					'button',
					{ className: 'btn btn-warning', style: btnStyle, onClick: this.props.onClick },
					'- Counter'
				);
			}
		}]);

		return RemoveCounterButton;
	}(_react2.default.Component);
		...
		_createClass(Counter, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(CounterNumber, { index: this.props.index, onClick: this.props.remove, count: this.props.count }),
					_react2.default.createElement(IncrementButton, { index: this.props.index, onClick: this.props.increment }),
					_react2.default.createElement(DecrementButton, { index: this.props.index, onClick: this.props.decrement })
				);
			}
		}]);
	...
	var CounterNumber = function (_React$Component5) {
		_inherits(CounterNumber, _React$Component5);

		function CounterNumber(props) {
			_classCallCheck(this, CounterNumber);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(CounterNumber).call(this, props));
		}
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'button',
							{ className: 'btn btn-danger pull-right', onClick: this.props.onClick.bind(this, this.props.index) },
							'X'
						)
					),
					_react2.default.createElement(
	...
	var IncrementButton = function (_React$Component6) {
		_inherits(IncrementButton, _React$Component6);

		function IncrementButton(props) {
			_classCallCheck(this, IncrementButton);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(IncrementButton).call(this, props));
		}
		...
		_createClass(IncrementButton, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'button',
					{ className: 'btn btn-primary', style: btnStyle, onClick: this.props.onClick.bind(this, this.props.index) },
					'+'
				);
			}
		}]);
	...
	var DecrementButton = function (_React$Component7) {
		_inherits(DecrementButton, _React$Component7);

		function DecrementButton(props) {
			_classCallCheck(this, DecrementButton);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(DecrementButton).call(this, props));
		}
		...
		_createClass(DecrementButton, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'button',
					{ className: 'btn btn-danger', style: btnStyle, onClick: this.props.onClick.bind(this, this.props.index) },
					'-'
				);
			}
		}]);
